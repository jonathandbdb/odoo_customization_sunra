...
class StockLot(models.Model):
    ...
    component_ids = fields.One2many(
        ...
        help="All bike components (motor, batteries, controller) currently mounted on this "
    ...
    def _sunra_inverse_component(self, component, component_type):
        # Comun a motor_id/controller_id: valida el tipo, libera la pieza anterior de ese tipo

...
class AccountMove(models.Model):
    ...
    def _get_invoiced_lot_values(self):
        # Enriquece la tabla de series de la factura con motor/fajas/controlador (D16).
        ...
        # Normalizar TODAS las filas con las tres claves: point_of_sale agrega dicts con
        ...
        empty_values = {"motor_name": "", "battery_names": "", "controller_name": ""}
        for values in res:

...
| `website_sale_installation_appointment` | eCommerce: método de envío con instalación — paso de checkout en **3 bloques tipo acordeón** (dirección · turno y fotos · pago) con guía de fotos definitiva, agenda la Cita, genera la tarea de Field Service e invita al cliente al portal al confirmar la venta; y pilas incluidas sin cargo cuando el método de envío las incluye |
...
| `website_sale_payment_method_price` | eCommerce: descuento o recargo por medio de pago y por sitio — recuadro con el precio de lista tachado, pill de porcentaje y el precio del medio como protagonista ("pagando con Transferencia bancaria"), en la grilla, la ficha y el carrito, y el descuento real con su IVA al elegir el medio en el checkout |
